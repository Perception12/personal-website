...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "kehinde.h.adejumobi@gmail.com",
    href: "mailto:kehinde.h.adejumobi@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+234 703 025 5420",
    href: "tel:+2347030255420",
  },
  {
    icon: MapPin,
    label: "Location",
              ...
              <div className="space-y-4">
                {contactInfo.map((item, i) => (
                  <a
                    key={i}
                    href={item.href}
                    className="flex flex-col md:flex-row items-start md:items-center gap-4 py-4 px-2 md:px-4 rounded-xl hover:bg-surface transition-colors group"
                  >
